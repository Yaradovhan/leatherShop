...
@section('content')
    ...
    <p><a href="{{ route('admin.products.categories.attributes.create', $category) }}" class="btn btn-success">Add
            Attribute</a></p>
...
{{--                <td>{{ $attribute->sort }}</td>--}}
{{--                <td>--}}
{{--                    <a href="{{ route('admin.products.categories.attributes.show', [$category, $attribute]) }}">{{ $attribute->name }}</a>--}}
{{--                </td>--}}
{{--                <td>{{ $attribute->type }}</td>--}}
{{--                <td>{{ $attribute->required ? 'Yes' : '' }}</td>--}}
{{--            </tr>--}}
