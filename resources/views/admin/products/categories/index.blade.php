...
@section('content')
    ...
    <p><a href="{{ route('admin.products.categories.create') }}" class="btn btn-success">Add Category</a></p>
            ...
            <tr>
                ...
                <td>
                    <div class="d-flex flex-row">
                        ...
                        <form method="POST" action="{{ route('admin.products.categories.up', $category) }}" class="mr-1">
                            @csrf
